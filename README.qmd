...
- If an adult has at least `30` energy points, and a random number between `0` and `1` is *less than* or *equal to* the `reproduction-rate`, a new seedling is created in a randomly selected patch with `0` age and `1` point of energy.
